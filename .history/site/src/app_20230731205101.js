...
function Body() {
  ...
  React.useEffect(()=>{
    let filteredResumes = resumes?.filter((resume)=>resume.basic_info.first_name.includes(filter))
  setResumes(resumes.filter(filteredResumes))
  },[filter])
        ...
        {/* Modal Backdrop/Modal */}
          ...
          <div className='container'>
            ...
            <div className='row px-5 mt-2 marginFix'>
              <input type='text' value={filter} onChange={e => setFilter(e.target.value)} className='w-100 form-control mb-3' placeholder='Type student name to search'></input>
            </div>
