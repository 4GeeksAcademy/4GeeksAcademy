  ...
  return (
      <main>
        ...
        {/* Modal Backdrop/Modal */}
          ...
          <div className='row justify-content-center'>
              <div className = 'position-relative col-md-6 rounded bg-light my-5 resume-modal'>
                  ...
                  {experience.map((role)=>{
                    return (
                      <div className='row my-2 mx-2 px-2 border-start border-3'>
                        <h4 className='mb-0'>{role.role}<span className='text-secondary font-weight-light'>{`/${role.company}`}</span></h4>
                        <p>{role.time}</p>
                      </div>
                    )
                  })}
