          ...
          <div className='row justify-content-center'>
              <div className = 'position-relative col-md-7 rounded bg-light my-5 resume-modal'>
                ...
                <div className='row mt-3 text-center'>
                  <div>
                    {profImg != null ?<img className='resumeProfImg' src={profImg}></img> : <img className='resumeProfImg' src='https://www.physiorehabgroup.co.nz/wp-content/uploads/generic-profile-square-580x580.jpg'></img>}
                  </div>
                </div>
