                  ...
                  {skills.length != 0 && skills.map((skill)=>{
                    ...
                    return (
                      <div className='row my-2'>
                        <h6 className='mb-0'>{skill.name}<span className='text-secondary light-text'>{` /${skill.level}`}</span></h6>
                        <div className='col-4'>
                          <div className='progress'>
                            <div className='progress-bar' role='progressbar' style={{width: level + '%', backgroundColor: 'lilac !important'}}  aria-valuenow={level} aria-valuemin='0' aria-valuemax='100'></div>
                          </div>
                        </div>
                      </div>
                    )
