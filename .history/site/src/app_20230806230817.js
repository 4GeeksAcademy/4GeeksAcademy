          ...
          <div className='container'>
            ...
            <div className='row px-5 mt-2 marginFix'>
              ...
              <div className='row justify-content-center px-5 studentProfContainer'>
                ...
                {resumes.map((resume)=>{
                  return (<StudentListing name={`${resume.basic_info.first_name} ${resume.basic_info.last_name}`} motto={resume.basic_info.motto} portfolioUrl={resume.basic_info.website} twitter={resume.basic_info.twitter} linkedIn={resume.basic_info.linkedin} gitHub={resume.basic_info.github} onClickHTML = {handleResume(resume)}/>)
                })}
              </div>
          </div>
      </main>
